...
function getWeatherDetails(name, lat, lon, country, state) {
        ...
        currentWeatherCard.innerHTML = `
            <div class="current-weather">
                ...
                <div class="weather-icon">
                    <img src="https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png" alt="${data.weather[0].description} weather icon" />
                </div>
            </div>
            <hr>
    ...
    alert("Failed to fetch sunset and rise details");
});
...
function getCityCoordinates() {
    ...
    fetch(GEOCODING_API_URL)
        ...
        .then(data => {
            ...
            // Destructuring the first result
